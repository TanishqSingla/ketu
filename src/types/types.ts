...
type HTMLPropsOf<T extends Tag> = T extends keyof JSX.IntrinsicElements ? JSX.IntrinsicElements[T] : never;
type CustomComponentProps<T extends Tag> = T extends ComponentType<infer P> ? P : never;
